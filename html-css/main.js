...
poi.addEventListener("click", (e) => {
    gsap.to("#body", {
        ...
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "./assets/Full Stack - Planning and UI Design.pdf";
        },
    })
});
...
poii.addEventListener("click", (e) => {
    gsap.to("#body", {
        ...
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "./assets/ResponsiveWebDesign_HTML-CSS.png";
        },
    })
});
...
poiii.addEventListener("click", (e) => {
    gsap.to("#body", {
        ...
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "./assets/Capy_animation/Sprite-Animation-Practice/index.html";
        },
    })
});