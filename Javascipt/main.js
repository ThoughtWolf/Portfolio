...
poi.addEventListener("click", (e) => {
    gsap.to("#body", {
        ...
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "https://thoughtwolf.github.io/Intercosmic-Space-Intruders/";
        },
    });
});
...
poii.addEventListener("click", (e) => {
    gsap.to("#body", {
        ...
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "./assets/particle_page/Particle-Pratice/index.html";
        },
    });
});
...
poiii.addEventListener("click", (e) => {
    gsap.to("#body", {
        ...
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "./assets/A-Simple-Game/Index.html";
        },
    });
});

poiv.addEventListener("click", (e) => {
    gsap.to("#body", {
        opacity: 0,
        duration: 1,
        ease: "power1.in",
        onComplete: () => {
            window.location.href = "./assets/Tic-Tac-Toe/index.html";
        },
    });
});
